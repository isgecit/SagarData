...
{
    public partial class ViewHandle : System.Web.UI.Page
    {
        ...
        protected void lnkUpdate_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("CreateAttachmentHandle.aspx?ATH=" + lnkUpdate.CommandArgument);
        }
     
        protected void btnCreate_Click(object sender, EventArgs e)
        {
            Response.Redirect("CreateAttachmentHandle.aspx");
        }
    }
}