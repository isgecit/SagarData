...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div style="margin-top: 20px; font-size: 12px; color: #646363" runat="server" id="divViewExistingAttachment"  Visible="false" >
             ...
             HeaderStyle-BackColor="White" HeaderStyle-Height="40"  OnPageIndexChanging="gvAttachment_PageIndexChanging" AllowPaging="true" PageSize="50" OnSelectedIndexChanged="gvAttachment_SelectedIndexChanged"> 
                ...
                <asp:TemplateField HeaderText="Document Id" Visible="false">
                    <ItemTemplate>
                        <asp:label runat="server" id="lblDocId"  Text='<%#Eval("t_dcid") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="File Name">
                    <ItemTemplate>
                        <asp:label runat="server" id="lblFilename"  Text=' <%#Eval("t_fnam") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
                   ...
                   <asp:TemplateField HeaderText="Download" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                       ...
                       <asp:TemplateField HeaderText="Copy Attachment">  
                   <%-- <EditItemTemplate>  
    ...
    <br />
    <div style="text-align: initial; font-size: 14px; font-weight: bold; text-align: center;">
         <asp:Button ID="btnCopyAttachment" CssClass="button" Text="Copy Checked Attachments" Visible="false" runat="server" OnClick="btnCopyAttachment_Click" BackColor="#53a9ff" ForeColor="White" />
    </div>
    ...
    <div style="margin-top: 20px; font-size: 12px; color: #646363" runat="server" id="divViewAttachment">
        <asp:GridView runat="server" HorizontalAlign="Center" ID="gvAttachment" AutoGenerateColumns="false" Width="90%"
             HeaderStyle-BackColor="White" HeaderStyle-Height="40"  OnPageIndexChanging="gvAttachment_PageIndexChanging" AllowPaging="true" PageSize="50" OnSelectedIndexChanged="gvAttachment_SelectedIndexChanged"> <%--OnRowDataBound="gvAttachment_RowDataBound" --%>
            <Columns>
                <asp:TemplateField HeaderText="File Name">
                    <ItemTemplate>
                        <%#Eval("t_fnam") %>
                ...
                <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                     <%--   '<%# Request.QueryString["ed"] == "y"?true:false%>' --%>
